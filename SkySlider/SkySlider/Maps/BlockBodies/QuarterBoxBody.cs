...
{
    public class QuarterBoxBody : RigidBody3D
    {
        private float sizeHalf; //half of the box's depth
        ...
        public QuarterBoxBody(Vector3 pos, Vector3 vel, float mass, float size)
